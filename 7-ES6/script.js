...
const familyMiller = ['Mary', 'Bob', 'Kelly'];
...
const allParks = [
    new Park('Pune-Okayama Friendship Garden', 1987, 0.2, 215),
    new Park('Tathawade Garden', 1894, 2.9, 3541),
    new Park('Kamala Nehru Park', 1953, 0.4, 949)
];

const allStreets = [
    new Street('Bajirao Road', 1999, 1.1, 4),
    new Street('Sinhagad Road', 2008, 2.7, 2),
    new Street('Prabhat Road', 2015, 0.8),
    new Street('Law College Road', 1982, 2.5, 5)
];
...
function reportParks(p) {
    ...
    // Average age
    const ages = p.map(curElem => new Date().getFullYear() - curElem.buildYear);
